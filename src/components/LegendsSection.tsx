...
const legends: Legend[] = [
  { era: "MENTOR — RETIRED", name: "Sakonji Urokodaki", title: "Former Water Hashira", body: ["The masked guardian of Mt. Sagiri — trained Giyu Tomioka and took Tanjiro under his wing. His red tengu mask hides a face weathered by decades of loss."], quote: "If Tanjiro fails to kill the demon… I will commit seppuku out of shame.", tags: ["Water Breathing Grandmaster", "Tengu Mask", "Mt. Sagiri"], color: "#4facfe" },
  { era: "TRAGEDY — RETIRED AT 35", name: "Jigoro Kuwajima", title: "Former Thunder Hashira", body: ["Sharp-eyed and demanding — trained Zenitsu and Kaigaku, lost his leg in battle, and committed seppuku when Kaigaku chose demonhood."], quote: "Every master passes on their everything to their student. What Kaigaku did… was an unforgivable betrayal of that bond.", tags: ["Thunder Breathing", "Zenitsu's Master", "Died of Seppuku"], color: "#ffd700" },
  { era: "GRIEF & REDEMPTION", name: "Shinjuro Rengoku", title: "Former Flame Hashira", body: ["Once a proud Hashira — broken by his wife's death and discovering Sun Breathing's supremacy. Only Kyojuro's dying message of love began his redemption."], quote: "Kyojuro… you were always the best of us.", tags: ["Flame Breathing", "Rengoku Family", "Path of Redemption"], color: "#fb923c" },
  { era: "FALLEN AT 17 — NEVER FORGOTTEN", name: "Kanae Kocho", title: "Former Flower Hashira", body: ["Believed humans and demons could coexist — murdered by Upper Rank Two Doma. She fought until dawn but her body failed her at age 17."], quote: "I hope one day… demons and humans can live together in peace. Even after I am gone.", tags: ["Flower Breathing", "Butterfly Mansion", "Killed by Doma (UR2)"], color: "#f472b6" },
  { era: "RETIRED — STILL SERVING", name: "Tengen Uzui", title: "Former Sound Hashira (Retired)", body: ["Lost his left eye and right hand defeating Upper Rank Six — then retired to lead grueling physical training for the next generation of slayers."], quote: "Whether I live or die — it will be in the most flamboyant way possible.", tags: ["Sound Breathing", "Defeated UR6", "Hashira Training Arc"], color: "#fbbf24" },
];
